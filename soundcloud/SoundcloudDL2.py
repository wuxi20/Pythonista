...
import requests, random, datetime, sys, webbrowser, console, urllib.request, urllib.parse, urllib.error, clipboard, bs4
...
def main():
    ...
    soup = bs4.BeautifulSoup(urllib.request.urlopen(song_page))
