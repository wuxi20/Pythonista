...
def download_and_save_video():
    ...
    if not os.path.exists('sample_mpeg4.mp4'):
        ...
        urllib.request.urlretrieve('http://a1408.g.akamai.net/5/1408/1388/2005110405/1a1a1ad948be278cff2d96046ad90768d848b41947aa1986/sample_mpeg4.mp4.zip', 'temp.zip')
